export const siteMeta = {
  ...
  availability:
    "Open to software engineering roles and collaborative development opportunities.",
};
...
export const capabilityCards = [
  ...
  },
  {
    ...
    points: ["TensorFlow / PyTorch", "Computer Vision", "NLP Applications"],
  },
  {
    label: "Full-Stack Solutions",
    color: "var(--blue)",
    title: "End-to-End Development",
    body: "Delivering complete software solutions from concept to deployment, combining frontend, backend, and AI/ML technologies for comprehensive applications.",
    points: ["System Architecture", "Deployment", "Problem Solving"],
  },
];
