export const siteMeta = {
  ...
  subtitle:
    "A portfolio structured like a product agency experience — sharp, nimble, and built to launch.",
  ...
  companyEmail: "polymath@justgotwyrd.com",
  phone: "+91 9555516408",
...
export const certificateCategories = [
  { key: "ai-ml", label: "AI & Machine Learning", icon: "AI" },
  { key: "web-dev", label: "Web Development", icon: "WEB" },
  { key: "programming", label: "Programming", icon: "CODE" },
  { key: "professional", label: "Professional", icon: "PRO" },
];
